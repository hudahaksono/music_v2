...
Array.from(document.getElementsByClassName('songItem')).forEach((element, i) => {
    element.getElementsByTagName('img')[0].src = songsPopuler[i].poster;
    element.getElementsByTagName('h5')[0].innerHTML = songsPopuler[i].songName;
})
...
//     `<p>Fade</p>
//         <div class="subtitle">Alan Walker</div>`,
//     `<p>All Black - Raftaar, Sukh-E Musical Doctorz 320kbps</p>
//         <div class="subtitle">Raftaar , Sukh-E Musical Doctorz</div>`,
//     `<p>Hai Dil Ye Mera</p>
//         <div class="subtitle">Arijit Singh</div>`,
//     `<p>Main Woh Chaand</p>
...
// Array.from(document.getElementsByClassName('songItem')).forEach((element, i) => {
//     element.getElementsByTagName('img')[0].src = posters[i];console.log(posters[i])
//     element.getElementsByTagName('h5')[0].innerHTML = songNames[i];
// })
